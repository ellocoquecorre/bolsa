...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($costo_total > $saldo_en_pesos) {
        ...
        $stmt_update_bonos->bind_param("iddsis", $cantidad_hoy, $nuevo_precio, $nuevo_ccl_compra, $fecha_hoy, $cliente_id, $ticker);
    ...
    <div class="row mx-2 mt-navbar">
        ...
        <div class="col-6 text-center">
            <div class="container-fluid my-4 efectivo">
                ...
                <form id="compra_bonos" method="POST" action="" onsubmit="return validarSaldo();">
