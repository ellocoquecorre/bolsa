...
// COMPRA DE ACCIONES
if (!function_exists('actualizarSaldo')) {
...
if (!function_exists('guardarAccion')) {
...
// RENDERIZAR ACCIONES
if (!function_exists('obtenerAcciones')) {
...
// GOOGLE FINANCE
if (!function_exists('obtenerPrecioActualGoogleFinance')) {
...
// CCL COMPRA
if (!function_exists('obtenerCCLCompra')) {
