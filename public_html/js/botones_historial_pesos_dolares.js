// botones_historial_pesos_dolares.js
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    btnAccionesPesos.addEventListener("click", () => {
        ...
        $('#historial_acciones_pesos').DataTable().columns.adjust().draw();
    });
    ...
    btnCedearPesos.addEventListener("click", () => {
        ...
        $('#historial_cedear_pesos').DataTable().columns.adjust().draw();
    });
    ...
    btnBonosPesos.addEventListener("click", () => {
        ...
        $('#historial_bonos_pesos').DataTable().columns.adjust().draw();
    });
    ...
    btnFondosPesos.addEventListener("click", () => {
        ...
        $('#historial_fondos_pesos').DataTable().columns.adjust().draw();
    });
    ...
    btnFondosDolares.addEventListener("click", () => {
        ...
        initDataTable('#historial_fondos_dolares', 0, columnasDolares);
    });
});
