...
// Obtener datos de la tabla bonos para el cliente y ticker en cuestión
$query = "SELECT * FROM bonos WHERE cliente_id = ? AND ticker_bonos = ?";
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Eliminar la línea de la tabla bonos
    $query_delete = "DELETE FROM bonos WHERE cliente_id = ? AND ticker_bonos = ?";
        ...
        <div class="col-8 text-center">
            <div class="container-fluid my-4 efectivo">
                ...
                <form id="venta_total" method="POST" action="">
                    ...
                    <input type="hidden" name="ticker" value="<?php echo $bono['ticker_bonos']; ?>">
                                ...
                                <div class="col-sm-8">
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" id="ticker" name="ticker"
                                            value="<?php echo $bono['ticker_bonos']; ?>" readonly>
                                    </div>
                                </div>
                            </div>
                            <!-- Fin Ticker -->
                                ...
                                <div class="col-sm-8">
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control"
                                            id="cantidad" name="cantidad" value="<?php echo formatear_numero($bono['cantidad_bonos']); ?>" readonly>
                                    </div>
                                </div>
                            </div>
                            <!-- Fin Cantidad -->
                                ...
                                <div class="col-sm-8">
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" id="fecha_compra" name="fecha_compra"
                                            value="<?php echo date("d-m-Y", strtotime($bono['fecha_bonos'])); ?>" readonly>
                                    </div>
                                </div>
                            </div>
                            <!-- Fin Fecha Compra -->
                                ...
                                <div class="col-sm-8">
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" id="precio_compra" name="precio_compra"
                                            value="<?php echo formatear_dinero($bono['precio_bonos']); ?>" readonly>
                                    </div>
                                </div>
                            </div>
                            <!-- Fin Precio Compra -->
                                ...
                                <div class="col-sm-8">
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" id="ccl_compra" name="ccl_compra"
                                            value="<?php echo formatear_dinero($bono['ccl_compra']); ?>" readonly>
                                    </div>
                                </div>
                            </div>
                            <!-- Fin CCL Compra -->
