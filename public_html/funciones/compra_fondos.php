...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($total_compra > $saldo_en_pesos) {
        ...
        $sql_insert_fondo = "INSERT INTO fondos (cliente_id, ticker_fondos, cantidad_fondos, precio_fondos, fecha_fondos, ccl_compra)
                             VALUES (?, ?, ?, ?, ?, ?)";
        $stmt_insert_fondo = $conexion->prepare($sql_insert_fondo);
        $stmt_insert_fondo->execute([$cliente_id, $ticker, $cantidad, $precio, $fecha, $ccl_compra]);
        ...
        <div class="col-md-12 col-lg-6 text-center">
            <div class="container-fluid my-4 efectivo">
                ...
                <form id="compra_fondos" method="POST" action="">
                    ...
                    <!-- Ticker -->
                    <div class="row mb-3 align-items-center">
                        <label for="ticker_fondos" class="col-sm-2 col-form-label text-start text-lg-end text-start text-lg-end">Ticker</label>
                        <div class="col-sm-10">
                            <div class="input-group">
                                <span class="input-group-text bg-light"><i class="fa-solid fa-chart-line"></i></span>
