document.addEventListener("DOMContentLoaded", function () {
    document.getElementById("ingresar_btn").addEventListener("click", function () {
        let monto = document.getElementById("ingresar_efectivo").value;
        ...
        fetch("../funciones/ingresar_efectivo.php", {
            method: "POST",
            body: formData
        })
        ...
        .then(data => {
            if (data.error) {
                ...
                document.getElementById("ingresar_efectivo").value = ""; // Limpiar el campo
            }
        })
