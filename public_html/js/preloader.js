...
document.addEventListener("DOMContentLoaded", function(event) {
  var phrases = shuffleArray([""Cebándole mate a los unicornios", "Manoteando laburos como puedo", "Ordenando el quilombo de conversaciones", "Trazando líneas como un capo", "Contemplando el vacío existencial", "Buscando un plan B (o C... o D...)", "Mezclando unos y ceros como un tucán", "Festejando porque sí", "Mandando fruta con estilo", "Haciendo que laburo", "Salvando al mundo... o algo así", "Soñando en grande, viste", "Bailando como tío en casamiento", "¿Hola? ¿Hay alguien ahí? ", "Tirando chistes malos pero con actitud", "Sacándole viruta al teclado", "Haciendo tiempo hasta la merienda", "Calculando cuánto falta para el finde", "Aguantando con café y dignidad", "Esperando que no se rompa nada", "Remando en dulce de leche"]);
