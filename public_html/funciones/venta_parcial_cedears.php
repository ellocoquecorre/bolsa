...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $stmt_update = $conn->prepare($sql_update_cedear);
                            ...
                            <div class="row mb-3 align-items-center">
                                ...
                                <div class="col-sm-8">
                                    <div class="input-group">
                                        ...
                                        <input type="text" placeholder="Máximo <?php echo htmlspecialchars($cantidad_max); ?> cedear" class="form-control"
