...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $ticker = $_POST['ticker'];
    $fecha = $_POST['fecha'];
    $ccl_compra = str_replace(',', '.', str_replace('.', '', $_POST['ccl_compra'])); // Formatear ccl_compra
    ...
    if ($total_compra > $saldo_en_pesos) {
        ...
        $sql_insert_cedear = "INSERT INTO cedear (cliente_id, ticker_cedear, cantidad_cedear, precio_cedear, fecha_cedear, ccl_compra_cedear) 
                              VALUES (?, ?, ?, ?, ?, ?)";
        $stmt_insert_cedear = $conexion->prepare($sql_insert_cedear);
        $stmt_insert_cedear->execute([$cliente_id, $ticker, $cantidad, $precio, $fecha, $ccl_compra]);
        ...
        <div class="col-md-12 col-lg-6 text-center">
            <div class="container-fluid my-4 efectivo">
                ...
                <form id="compra_cedears" method="POST" action="">
                    ...
                    <!-- Ticker -->
                    <div class="row mb-3 align-items-center">
                        <label for="ticker_cedears" class="col-sm-2 col-form-label text-start text-lg-end text-start text-lg-end">Ticker</label>
                        <div class="col-sm-10">
                            <div class="input-group">
                                <span class="input-group-text bg-light"><i class="fa-solid fa-chart-line"></i></span>
